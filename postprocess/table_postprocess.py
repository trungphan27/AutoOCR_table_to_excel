...
try:
    import paddle
except ImportError:  # ONNX-only deployment
    paddle = None
...
class TableLabelDecode(AttnLabelDecode):
    ...
    def __call__(self, preds, batch=None):
        ...
        if paddle is not None and isinstance(structure_probs, paddle.Tensor):
            structure_probs = structure_probs.numpy()
        if paddle is not None and isinstance(bbox_preds, paddle.Tensor):
