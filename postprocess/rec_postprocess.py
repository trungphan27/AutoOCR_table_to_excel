...
try:
...
except ImportError:  # Default CTC decoding also supports ONNX-only deployment.
    class _MissingPaddle:
        ...
        def __getattr__(self, name):
            raise ImportError(
                "This recognition decoder requires PaddlePaddle; "
                "the default CTC decoder works without it.")

    paddle = _MissingPaddle()
    F = None
import re
